...
def Pixelhop_fit(weight_path, feature, useDC):
    ...
    print("       <Info>        feature with bias shape: %s"%str(feature_w_bias.shape))
...
def PixelHop_Unit(feature, dilate=1, pad='reflect', weight_name='tmp.pkl', getK=False, useDC=False, energypercent=0.92):
    transformed_feature = PixelHop_Unit_GPU(feature, dilate, pad, weight_name, getK, useDC, energypercent)
